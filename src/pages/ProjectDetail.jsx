    ...
    <div className="w-full bg-transparent overflow-hidden">
      ...
      <section className="relative h-[100vh] w-full overflow-hidden flex flex-col justify-end px-6 md:px-20 lg:px-32 pb-24">
         ...
         <div className="relative z-20 max-w-7xl">
            <Link to="/projects" className="inline-flex items-center gap-6 text-[11px] font-bold uppercase tracking-[1em] text-yellow-500 mb-12 group interactive" data-cursor="BACK">
            ...
            >
               ...
               <div className="flex flex-wrap gap-12 items-center text-[10px] font-bold uppercase tracking-[0.5em]  italic font-serif">
                  ...
                  <span className="/60">Cycle: {project.year}</span>
                  <div className="h-px w-16 bg-gold/10" />
                  <span className="/40 uppercase tracking-[1em]">{project.type}</span>
               </div>
            </motion.div>
         </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-16 pt-24 border-t border-charcoal/10">
                  {[
                    ...
                    <div key={i} className="space-y-8 group cursor-pointer interactive">
                       ...
                       <h5 className="text-[11px] font-bold uppercase tracking-[0.5em] text-yellow-500/60">{item.title}</h5>
