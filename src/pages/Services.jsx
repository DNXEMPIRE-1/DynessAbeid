    ...
    <div className="w-full bg-transparent overflow-hidden">
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 relative overflow-hidden flex flex-col items-center text-center">
        ...
        >
          ...
          <p className="max-w-4xl mt-20 text-2xl md:text-3xl font-serif italic text-gold/40 font-light leading-relaxed mx-auto border-l border-gold/20 pl-12 uppercase tracking-wide">
              ...
              >
                 <div className="space-y-16">
                    ...
                    <div className="space-y-8">
                       ...
                       <p className="text-xl md:text-2xl opacity-40 italic font-serif leading-relaxed font-light group-hover:opacity-100 group-hover:text-cream transition-all duration-700">
                          {serv.desc}
                       </p>
                    </div>
                 </div>
                 ...
                 <div className="pt-20 border-t border-white/5 space-y-10">
                    <span className="text-[10px] font-bold uppercase tracking-[1em] text-gold/20 italic block">Creative Focus Points</span>
                    <div className="flex flex-wrap gap-6">
                       {serv.feat.map((f, fi) => (
                          <span key={fi} className="text-[10px] uppercase font-bold tracking-[0.4em] px-8 py-4 border border-white/5 rounded-full opacity-30 hover:opacity-100 hover:border-gold hover:text-gold transition-all duration-700 cursor-default">{f}</span>
                       ))}
                    </div>
                 </div>
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 bg-black/40 relative">
         <div className="max-w-5xl mx-auto flex flex-col items-center text-center space-y-24">
            <h4 className="text-[11px] font-bold uppercase tracking-[1.5em] text-gold/20 italic">Mission Outcome Aura</h4>
            ...
            <p className="text-2xl md:text-4xl font-serif italic text-cream font-light max-w-4xl leading-relaxed opacity-60 border-x border-gold/10 px-12">
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 border-t border-white/5 bg-[#050505]">
         <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-24">
            <div className="space-y-10 text-center lg:text-left">
               <h4 className="text-5xl md:text-[8vw] font-display uppercase italic leading-none mix-blend-exclusion">Atelier <br /> <span className="text-gold font-serif not-italic text-outline uppercase tracking-tight">Inquiry.</span></h4>
               <p className="opacity-40 font-serif italic text-2xl md:text-3xl font-light">Let's weave visual narratives for your next regional summit.</p>
            </div>
            <Link to="/contact" className="group bg-gold text-black px-24 py-12 rounded-full font-display uppercase tracking-widest text-[14px] hover:bg-cream transition-all duration-700 interactive flex items-center justify-center gap-10 shadow-[0_0_100px_rgba(197,163,99,0.3)]">
