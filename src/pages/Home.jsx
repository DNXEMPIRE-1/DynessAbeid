...
const Home = () => {
  ...
  return (
    <div className="w-full bg-transparent text-cream selection:bg-gold selection:text-black">
      ...
      <section className="relative h-screen flex flex-col justify-center pt-20 px-6 md:px-20 lg:px-32 z-50 overflow-hidden">
         ...
         >
            ...
            >
               <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-[1em] text-gold/60 animate-pulse italic">
            ...
            <motion.div style={{ y: titleY }} className="relative">
               ...
               <motion.p 
                  {...fadeUp}
                  className="mt-8 md:mt-12 max-w-2xl text-lg md:text-2xl font-serif italic text-cream font-light leading-relaxed tracking-tight opacity-80"
               >
            ...
            <motion.div {...fadeUp} className="mt-12 md:mt-16 flex flex-wrap gap-8 md:gap-12 items-center">
               <Link to="/projects" className="group relative overflow-hidden bg-gold text-black px-12 md:px-16 py-6 md:py-8 rounded-full font-display uppercase tracking-widest text-[10px] md:text-[12px] hover:bg-cream transition-all duration-700 shadow-[0_0_80px_rgba(197,163,99,0.2)] interactive" data-cursor="VIEW">
                  Explore Gallery
               </Link>
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 relative bg-[#050505]/80 backdrop-blur-md">
         <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-32 items-center">
            <motion.div {...reveal} className="lg:w-1/2 relative">
               <div className="aspect-[4/6] rounded-[100px] overflow-hidden border border-gold/10 glass-card relative group">
                  <img src="/projects/IMG-20260225-WA0055.jpg" alt="Artist at work" className="w-full h-full object-cover scale-110 group-hover:scale-100 transition-all duration-1000 grayscale opacity-40 group-hover:opacity-100 group-hover:grayscale-0" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#050505] via-transparent to-transparent" />
                  <div className="absolute bottom-16 left-16">
                     <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-gold/60 italic block mb-4">The Methodology</span>
            ...
            <div className="lg:w-1/2 space-y-16">
              <div className="space-y-8">
                <h2 className="text-[10px] font-bold uppercase tracking-[1em] text-gold/40 italic">Global Identity</h2>
                <h3 className="text-6xl md:text-8xl font-display leading-[0.8] tracking-tighter uppercase italic">Strategic <br /> <span className="text-outline">Artistry.</span></h3>
              </div>
              <div className="space-y-12 max-w-xl">
                <p className="text-2xl font-serif italic text-cream/80 leading-relaxed font-light">
                ...
                <div className="grid grid-cols-2 gap-12 pt-12 border-t border-white/5">
                   <div className="space-y-4">
                      ...
                      <p className="text-[10px] opacity-30 uppercase font-black tracking-widest leading-loose">Visual assets that transcend standard corporate design.</p>
                   </div>
                   <div className="space-y-4">
                      ...
                      <p className="text-[10px] opacity-30 uppercase font-black tracking-widest leading-loose">Logic-driven layouts for high-stakes institutional review.</p>
                   </div>
                </div>
              </div>
            </div>
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 bg-black/40">
         <div className="max-w-7xl mx-auto space-y-20">
            <div className="flex flex-col md:flex-row justify-between items-end gap-12">
               <h3 className="text-5xl md:text-8xl font-display uppercase tracking-tight italic">Curated <br /> <span className="text-gold font-serif not-italic text-outline">Exhibition.</span></h3>
               <p className="text-lg font-serif italic opacity-40 max-w-sm border-l border-gold/20 pl-10">Selected highlights from our boutique design studio servicing East Africa.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
               {[
                 { title: "Strategic Soul", type: "Narrative Piece #01", img: "/projects/VID-20260303-WA0048.mp4", isVideo: true },
                 { title: "Visual Logic", type: "Exhibition Piece #02", img: "/projects/IMG-20260303-WA0056.jpg" }
               ].map((project, i) => (
                 <motion.div 
                    key={i}
                    {...fadeUp}
                 ...
                 >
                    <div className="aspect-[4/5] rounded-[60px] overflow-hidden border border-gold/10 glass-card relative group cursor-pointer">
                       {project.isVideo ? (
                          <video src={project.img} className="w-full h-full object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 transition-all duration-1000" autoPlay loop muted playsInline />
                       ) : (
                          <img src={project.img} alt={project.title} className="w-full h-full object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 transition-all duration-1000" />
                       )}
                    ...
                    <div className="flex justify-between items-start pt-8 border-t border-white/5">
                       <div className="space-y-2">
                          <h4 className="text-3xl font-serif italic text-cream/90 group-hover:text-gold transition-colors">{project.title}</h4>
                          <span className="text-[10px] font-bold uppercase tracking-[0.4em] opacity-30 italic font-serif">{project.type}</span>
                       </div>
                    </div>
                 </motion.div>
               ))}
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 text-center bg-[#050505]">
         <div className="max-w-5xl mx-auto glass-card p-24 md:p-40 rounded-[120px] space-y-16 border-gold/10 relative overflow-hidden">
            <span className="text-[10px] font-bold uppercase tracking-[1em] text-gold/40 animate-pulse italic">Phase Engagement Initiation</span>
            ...
            <p className="text-2xl font-serif italic text-cream/60 max-w-2xl mx-auto leading-relaxed border-x border-gold/10 px-12">
