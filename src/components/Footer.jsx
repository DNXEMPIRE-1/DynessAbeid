    ...
    <footer className="relative min-h-screen py-40 px-6 md:px-20 lg:px-32 z-10 flex flex-col justify-between items-center bg-cream text-center text-charcoal overflow-hidden border-t border-charcoal/10">
      ...
      <div className="relative z-10 max-w-5xl flex flex-col items-center space-y-24">
         <motion.div 
            ...
            className="space-y-6"
         >
            <span className="text-[10px] font-bold uppercase tracking-[0.8em] text-gold animate-pulse flex items-center justify-center gap-4">
               <Plus size={10} /> Initiate Interaction <Plus size={10} />
            </span>
            <a href="mailto:hello@dyness.pro" className="group text-5xl md:text-[10vw] font-serif italic font-black leading-none tracking-tighter hover:text-gold transition-colors interactive flex items-center gap-8" data-cursor="WRITE">
               hello@dyness.pro
            ...
            <p className="text-lg md:text-xl font-serif italic text-gold/40 mt-12 max-w-xl mx-auto border-l border-gold/10 pl-8">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-24 w-full text-left">
            <div className="space-y-8">
               <h5 className="text-[10px] font-bold uppercase tracking-widest text-gold opacity-40">Regional Presence</h5>
               <div className="flex flex-col gap-4 font-serif italic text-3xl font-black">
                  <p className="hover:text-gold transition-colors cursor-pointer">Dar Es Salaam, TZ</p>
                  <p className="hover:text-gold transition-colors cursor-pointer">Nairobi, KE</p>
                  <p className="opacity-20">East African Region</p>
               </div>
            </div>

            <div className="space-y-8">
               <h5 className="text-[10px] font-bold uppercase tracking-widest text-gold opacity-40">Digital Extension</h5>
               <div className="flex flex-col gap-6 text-[11px] font-bold tracking-[0.3em] uppercase">
                  <a href="#" className="flex items-center gap-4 hover:text-gold transition-colors interactive group">
                     <Instagram size={14} className="opacity-40 group-hover:opacity-100" /> @dyness_studio
                  </a>
                  <a href="#" className="flex items-center gap-4 hover:text-gold transition-colors interactive group">
                     <Globe size={14} className="opacity-40 group-hover:opacity-100" /> LinkedIn Professional
                  </a>
                  <a href="#" className="flex items-center gap-4 hover:text-gold transition-colors interactive group">
                     <MousePointer2 size={14} className="opacity-40 group-hover:opacity-100" /> Behance Showcase
                  </a>
               </div>
            </div>

            <div className="space-y-8 md:text-right">
               <h5 className="text-[10px] font-bold uppercase tracking-widest text-gold opacity-40">Authentic Strategy</h5>
