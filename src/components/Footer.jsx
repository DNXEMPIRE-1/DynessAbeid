  ...
  return (
    <footer className="relative min-h-screen py-40 px-6 md:px-20 lg:px-32 z-10 flex flex-col justify-between items-center bg-brown text-center  overflow-hidden border-t border-cream/10">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.03]">
         <span className="text-[35vw] font-serif font-black italic transform -rotate-12 whitespace-nowrap select-none">Work.</span>
      </div>
      ...
      <div className="relative z-10 max-w-5xl flex flex-col items-center space-y-24">
         ...
         >
            ...
            <p className="text-lg md:text-xl font-serif italic text-yellow-500 mt-12 max-w-xl mx-auto border-l border-gold/10 pl-8">
               We help organizations share their impact clearly through strategic design.
            </p>
         </motion.div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-24 w-full text-left">
            ...
            <div className="space-y-8 md:text-right">
               ...
               <div className="text-[10px] font-bold tracking-[0.2em] uppercase space-y-4">
                  ...
                  <p className=" italic font-serif">Visual Designer & Consultant</p>
