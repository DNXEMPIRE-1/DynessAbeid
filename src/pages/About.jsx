    ...
    <div className="w-full bg-transparent overflow-hidden">
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 relative overflow-hidden flex flex-col items-center text-center">
        ...
        >
          ...
          <p className="max-w-4xl mt-12 text-2xl md:text-4xl font-serif italic text-charcoal/60 leading-relaxed font-light mx-auto border-x border-gold/20 px-12 uppercase tracking-wide">
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 relative z-10 bg-white/40 backdrop-blur-sm">
         <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            <motion.div {...fadeUp} className="space-y-16">
               <h2 className="text-[11px] font-bold uppercase tracking-[0.6em] text-gold/60 group flex items-center gap-6">
            ...
            >
               <div className="size-24 rounded-full bg-gold/5 flex items-center justify-center text-gold/60 mb-12 border border-gold/10">
                ...
                <p className="text-2xl md:text-3xl font-serif italic text-charcoal/80 leading-relaxed font-light border-l-2 border-gold/40 pl-12">
               ...
               <div className="pt-20 flex flex-wrap gap-6">
                  {['Artistic Polish', 'Strategic Soul', 'Bespoke Logic', 'East African Vision'].map((tag, i) => (
                     <span key={i} className="text-[10px] font-bold uppercase tracking-[0.3em] px-8 py-4 border border-charcoal/10 rounded-full opacity-30 hover:opacity-100 hover:border-gold hover:text-gold transition-all duration-700 cursor-default">{tag}</span>
                  ))}
               </div>
            </motion.div>
         </div>
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 relative overflow-hidden bg-cream/50">
         <div className="max-w-7xl mx-auto space-y-20">
            <div className="text-center space-y-8">
               <span className="text-[10px] font-bold uppercase tracking-[1.5em] text-gold/60 animate-pulse italic block">Author Perspective</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
               {[
                  ...
                  >
                      <div className="size-16 rounded-full border border-gold/20 flex items-center justify-center text-gold/40 group-hover:bg-gold group-hover:text-white transition-all duration-700">
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 text-center bg-cream">
         <div className="max-w-4xl mx-auto space-y-20 py-20 relative isolate">
             <h4 className="text-[11px] font-bold uppercase tracking-[1.5em] text-gold/60 italic">Regional Aesthetic Footprint</h4>
