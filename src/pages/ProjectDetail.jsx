    ...
    <div className="w-full bg-transparent overflow-hidden">
      ...
      <section className="relative h-[100vh] w-full overflow-hidden flex flex-col justify-end px-6 md:px-20 lg:px-32 pb-24">
         <motion.img 
            ...
            animate={{ scale: 1, filter: 'grayscale(0%) opacity(0.3)' }}
         ...
         <div className="relative z-20 max-w-7xl">
            <Link to="/projects" className="inline-flex items-center gap-6 text-[11px] font-bold uppercase tracking-[1em] text-gold/60 mb-12 group interactive" data-cursor="BACK">
            ...
            >
               <span className="text-[10px] font-bold uppercase tracking-[1.5em] text-gold/30 animate-pulse italic block">Exhibition Narrative</span>
               ...
               <div className="flex flex-wrap gap-12 items-center text-[10px] font-bold uppercase tracking-[0.5em] opacity-40 italic font-serif">
                  ...
                  <span className="text-cream/60">Cycle: {project.year}</span>
                  <div className="h-px w-16 bg-gold/10" />
                  <span className="text-cream/40 uppercase tracking-[1em]">{project.type}</span>
               </div>
            </motion.div>
         </div>
      ...
      {/* 🔮 STRATEGIC CURATION */}
      <section className="section-v-pad px-6 md:px-20 lg:px-32 relative z-10 bg-[#050505]/60 backdrop-blur-xl">
         <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-start">
            <div className="space-y-20">
               <div className="space-y-10">
                  <h2 className="text-[11px] font-bold uppercase tracking-[0.8em] text-gold/40 group flex items-center gap-8">
                     <span className="h-[1px] bg-gold/40 w-16" /> The Challenge Flow
                  </h2>
                  <p className="text-3xl md:text-5xl font-serif italic text-cream/90 font-light leading-snug tracking-tight border-l border-gold/20 pl-16">
                     {project.challenge}
                  </p>
               </div>
            ...
            <motion.div 
               ...
               viewport={{ once: true }}
               className="glass-card p-16 md:p-32 rounded-[120px] border-gold/5 space-y-20 flex flex-col justify-center relative overflow-hidden"
            >
               <div className="space-y-10">
                  <h2 className="text-[11px] font-bold uppercase tracking-[1em] text-gold/40 animate-pulse flex items-center gap-6 italic">
                     <Sparkles size={16} strokeWidth={1} /> Strategic Alchemy
                  </h2>
                  <p className="text-xl md:text-3xl leading-relaxed text-cream/70 italic font-serif font-light border-l border-gold/20 pl-16">
                     {project.solution}
                  </p>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-16 pt-24 border-t border-white/5">
                  {[
                    ...
                    <div key={i} className="space-y-8 group cursor-pointer interactive">
                       ...
                       <p className="text-[13px] opacity-30 group-hover:opacity-100 transition-all duration-700 font-serif italic leading-loose">{item.desc}</p>
                    </div>
                  ))}
               </div>
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 bg-black border-y border-white/5">
         <div className="max-w-7xl mx-auto space-y-20">
            <div className="text-center space-y-8">
               <h2 className="text-[10px] font-bold uppercase tracking-[2em] text-gold/20 italic">Aesthetic Evidence</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
               <motion.div whileHover={{ y: -20 }} className="aspect-[4/3] rounded-[80px] overflow-hidden border border-gold/5 glass-card flex items-center justify-center group">
                  <img src={project.img} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-[2000ms] scale-125 group-hover:scale-105" />
               </motion.div>
               <motion.div whileHover={{ y: -20, delay: 0.1 }} className="aspect-[4/3] rounded-[80px] overflow-hidden border border-gold/5 glass-card flex items-center justify-center group">
                  <img src="/projects/IMG-20260303-WA0057.jpg" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-[2000ms] scale-125 group-hover:scale-105" />
               </motion.div>
            </div>
         </div>
      </section>
      ...
      <section className="section-v-pad px-6 md:px-20 lg:px-32 text-center bg-[#050505]">
         <div className="max-w-5xl mx-auto glass-card p-24 md:p-40 rounded-[150px] space-y-20 border-gold/5 bg-gradient-to-br from-white/[0.01] to-transparent relative isolate overflow-hidden">
            ...
            <div className="pt-24">
               <Link to="/contact" className="group bg-gold text-black px-24 py-12 rounded-full font-display uppercase tracking-widest text-[14px] shadow-[0_50px_100px_rgba(197,163,99,0.2)] hover:bg-cream transition-all duration-700 interactive flex items-center justify-center gap-10 mx-auto w-fit">
